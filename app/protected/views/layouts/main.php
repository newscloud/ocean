...
<div class="container" >
	...
	'brand' => 'Ocean', // '<img src="http://cloud.geogram.com/images/geogram-logo.gif" style="height:30px;">',
	...
	'items' => array(
	  (!Yii::app()->user->isGuest ? array(	   
			...
			'items' => array(
				...
				array('label'=>'Domains', 'url'=>array('/domain/admin'), ),
			)
  	  ) : array() ),
 ...
 array('url'=>'http://link.lookahead.io/tutsdoapi', 'label'=>'Building with the Digital Ocean API'), 
